    ...
    >
      ...
      >
        ...
        <p className="text-lg max-w-3xl mx-auto mb-8">
          ...
          <span className="text-yellow-400">SipSpot</span>, founded on March 15,
          2024, by Gayane Harutyunyan and Hovhannes Khachatryan, is the creation
          of two enthusiasts in search of something extraordinary. As we like to
          say, &quot;Good days start with great coffee,&quot; and here at{" "}
          <span className="text-yellow-400">SipSpot</span>, we`&apos;re
          dedicated to making every moment count.
        </p>
        <p className="text-lg max-w-3xl mx-auto mb-8">
          Find your new favorite spot to connect. Whether you`&apos;re catching
          up with friends or diving into a good book, our cozy corners and
          aromatic brews await you. We believe{" "}
          <span className="text-yellow-400">SipSpot</span> will warmly find its
          way into the hearts of coffee enthusiasts everywhere.
        </p>
      </div>
    </section>
  );
